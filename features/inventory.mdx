...
<Steps>
  ...
  <Step title="Fill in the details">
    ...
    <Tip>
      To avoid typing a long barcode manually: add the item to the cart from the Sales view using the barcode scanner (**Escanear**). If the code is not found, the app prompts you to create a new product with the scanned code pre-filled. See [Barcode scanner](/features/scanner).
    </Tip>
  </Step>
  <Step title="Save">
